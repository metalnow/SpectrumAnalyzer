...
#define SMARTRF_SETTING_MDMCFG1    0x43 //0x22	// channel spacing exponent 0x03?
#define SMARTRF_SETTING_MDMCFG0    0xff //0xF8  // Channel spacing: Fxosc/2^18 (~99.182) * (256*mantissa) ^ exp . Desired 333KHz.
